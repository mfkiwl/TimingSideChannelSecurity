...
#define MASK_SINGLE_FLOAT (1 << 2)
#define MASK_EXPLICIT_RELOCS (1 << 3)
#define MASK_NO_FDIV (1 << 4)
#define MASK_SOFT_FLOAT (1 << 5)
#define MASK_SOFT_FLOAT_ABI (1 << 6)
#define MASK_MEMCPY (1 << 7)
#define MASK_MULDIV (1 << 8)
#define MASK_RVC (1 << 9)
#define MASK_SAVE_RESTORE (1 << 10)
...
enum opt_code
{
  ...
  OPT_mdouble_float = 1185,                  /* -mdouble-float */
  OPT_mexplicit_relocs = 1186,               /* -mexplicit-relocs */
  OPT_mfdiv = 1187,                          /* -mfdiv */
  OPT_mfloat = 1188,                         /* -mfloat */
  OPT_mhard_float = 1189,                    /* -mhard-float */
  OPT_mmemcpy = 1190,                        /* -mmemcpy */
  OPT_mmuldiv = 1191,                        /* -mmuldiv */
  OPT_mno_fdiv = 1192,                       /* -mno-fdiv */
  OPT_mno_float = 1193,                      /* -mno-float */
  OPT_mplt = 1194,                           /* -mplt */
  OPT_mrvc = 1195,                           /* -mrvc */
  OPT_msave_restore = 1196,                  /* -msave-restore */
  OPT_msingle_float = 1197,                  /* -msingle-float */
  OPT_msmall_data_limit_ = 1198,             /* -msmall-data-limit= */
  OPT_msoft_float = 1199,                    /* -msoft-float */
