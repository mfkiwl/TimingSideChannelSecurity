/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/thinh/fpga-zynq/rocket-chip/riscv-tools/riscv-gnu-toolchain/build/src/newlib-gcc/gcc/config/riscv/riscv.md'.  */
...
{
  if (c >= CONSTRAINT_Z && c <= CONSTRAINT_YG)
    return;
