...
enum opt_code
{
  ...
  OPT_mbionic = 1183,                        /* -mbionic */
  OPT_mbranch_cost_ = 1184,                  /* -mbranch-cost= */
  ...
  OPT_mfloat = 1189,                         /* -mfloat */
  OPT_mglibc = 1190,                         /* -mglibc */
  OPT_mhard_float = 1191,                    /* -mhard-float */
  OPT_mmemcpy = 1192,                        /* -mmemcpy */
  OPT_mmuldiv = 1193,                        /* -mmuldiv */
  OPT_mmusl = 1194,                          /* -mmusl */
  OPT_mno_fdiv = 1195,                       /* -mno-fdiv */
  OPT_mno_float = 1196,                      /* -mno-float */
  OPT_mplt = 1197,                           /* -mplt */
  OPT_mrvc = 1198,                           /* -mrvc */
  OPT_msave_restore = 1199,                  /* -msave-restore */
  OPT_msingle_float = 1200,                  /* -msingle-float */
  OPT_msmall_data_limit_ = 1201,             /* -msmall-data-limit= */
  OPT_msoft_float = 1202,                    /* -msoft-float */
  OPT_mtune_ = 1203,                         /* -mtune= */
  OPT_muclibc = 1204,                        /* -muclibc */
  OPT_n = 1205,                              /* -n */
